...
import {
  ...
  useDeleteComment,
  useUpdatePost,
} from "@/infrastructure/apis/api-management/feed"
  ...
  return (
    <Card className="mb-6 overflow-hidden">
        ...
        <Link
          to={
            post.authorId === currentUser?.id
              ? AppRoute.Profile
              : `${AppRoute.Profile}/${post.authorId}`
          }
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will permanently delete this post. This action cannot
                    be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
      ...
      <CardFooter className="flex flex-col gap-3 p-3">
        <div className="flex w-full items-center justify-between px-2 text-sm text-muted-foreground">
          <span>
        ...
        <div className="flex w-full gap-2 border-t pt-2">
          ...
          >
            <Heart
              className={`mr-2 h-4 w-4 ${post.isLikedByMe ? "fill-current" : ""}`}
            />
            Like
          </Button>
          <Button
          ...
          <div className="space-y-3 pt-2">
            {post.comments?.map((comment: any) => (
              <div key={comment.id} className="flex gap-3">
                <Link
                  to={
                    comment.authorId === currentUser?.id
                      ? AppRoute.Profile
                      : `${AppRoute.Profile}/${comment.authorId}`
                  }
                >
                ...
                <div className="group flex-1 overflow-hidden rounded-lg p-3">
